...
var posWords = API.shuffle([
  ...
  var negWords = API.shuffle([
	...
	return iatExtension({
		...
		category1 : {
			name : 'Muslim people', //Will appear in the data.
			title : {
				media : {word : 'Muslim people'}, //Name of the category presented in the task.
		...
		category2 :	{
			name : 'Hindu people', //Will appear in the data.
			title : {
				media : {word : 'Hindu people'}, //Name of the category presented in the task.
				css : {color:'#31940F','font-size':'1.8em'}, //Style of the category title.
				height : 4 //Used to position the "Or" in the combined block.
			}, 
			stimulusMedia : [ //Stimuli content as PIP's media objects
